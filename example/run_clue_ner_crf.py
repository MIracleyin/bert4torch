...
processor = NERDataProcessor(train['1'])
...
checkpoint = Checkpoint(ner_span_f1, predict_classical_ner, dev_data, test['1'], offset=offset, id2label=processor.id2label,
                        texts=test['0'])
model = CRFNer(model_path, processor.num_class)
